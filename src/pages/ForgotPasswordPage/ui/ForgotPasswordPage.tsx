...
import { useForgotPasswordMutation } from '@/shared/api/authApi/authApi';
...
const ForgotPasswordPage = () => {
  ...
  const onSubmit = (form: { email: string }) => {
    ...
    navigate(ROUTER_PATHS.RESET_PASSWORD, { state: { prevPage: ROUTER_PATHS.FORGOT_PASSWORD }, replace: true });
  };
