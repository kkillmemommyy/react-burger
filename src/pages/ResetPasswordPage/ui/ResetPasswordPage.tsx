...
import { useResetPasswordMutation } from '@/shared/api/authApi/authApi';
import { z } from 'zod';
...
const ResetPasswordPage = () => {
  ...
  if (location.state?.prevPage !== ROUTER_PATHS.FORGOT_PASSWORD) {
    return <Navigate to={ROUTER_PATHS.FORGOT_PASSWORD} replace />;
  }
